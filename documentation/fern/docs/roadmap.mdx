GPTHOUSE is [Open-Source](https://github.com/comet-ml/gpthouse) and is under very active development. We use the feedback from the GPTHOUSE community to drive the roadmap, this is very much a living document that will change as we release new features and learn about new ways to improve the product.

<Tip>
If you have any ideas or suggestions for the roadmap, you can create a [new Feature Request issue](https://github.com/comet-ml/gpthouse/issues/new/choose) in the GPTHOUSE Github repo.
</Tip>

## 🚀 What have we recently launched? 
Curious about our latest updates? Explore everything we’ve shipped in our [changelog](/docs/gpthouse/changelog).
...
**Projects & Dataset improvements**:
  ...
  - Dataset versioning
  - Introduce evaluation features in the GPTHOUSE playground
...
add your own on [Github Issues](https://github.com/comet-ml/gpthouse/issues/).
