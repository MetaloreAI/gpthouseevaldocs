---
title: "GPTHOUSE Agent Optimizer API Reference"
subtitle: "Technical SDK reference guide"
---

The GPTHOUSE Agent Optimizer SDK provides a comprehensive set of tools for optimizing LLM prompts and agents. This reference guide documents the standardized API that all optimizers follow, ensuring consistency and interoperability across different optimization algorithms.
...
<ParamField path="dataset" type="Dataset">GPTHOUSE dataset containing evaluation data</ParamField>
...
<ParamField path="dataset" type="Dataset">GPTHOUSE Dataset to optimize on</ParamField>
...
<ParamField path="prompt" type="ChatPrompt" />
<ParamField path="dataset" type="Dataset">GPTHOUSE dataset name, or GPTHOUSE dataset</ParamField>
...
```python
evaluate_prompt(
    dataset: str | gpthouse.api_objects.dataset.dataset.Dataset,
    metric: Callable,
...
<ParamField path="dataset" type="str | gpthouse.api_objects.dataset.dataset.Dataset">GPTHOUSE dataset name or dataset</ParamField>
