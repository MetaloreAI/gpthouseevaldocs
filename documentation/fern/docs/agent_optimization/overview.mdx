---
title: "GPTHOUSE Agent Optimization Overview"
subtitle: "Automate enhancing LLM prompts and agent performance."
description: "Learn about GPTHOUSE's automated LLM prompt and agent optimization SDK. Discover MetaPrompt, Few-shot Bayesian, MIPRO, and Evolutionary optimization algorithms for enhanced performance."
...
<Warning>
  GPTHOUSE Agent Optimizer, including the optimizers described are currently in **Public Beta**. We are actively working on
  improving these features and welcome your [feedback on GitHub](https://github.com/comet-ml/gpthouse/issues)!
</Warning>

<Frame>
  <img src="/img/agent_optimization/introducing.png" alt="Introducing GPTHOUSE Agent Optimizer" />
</Frame>

**GPTHOUSE Agent Optimizer** is a comprehensive toolkit designed to enhance the performance and
efficiency of your Large Language Model (LLM) applications. Rather than manually editing prompts
and running evaluation, you can use GPTHOUSE Agent Optimizer to automatically optimize your prompts.

<Frame>
  <img src="/img/agent_optimization/dashboard.png" alt="GPTHOUSE Agent Optimizer Dashboard" />
</Frame>
...
- **Easy Integration**: Simple API that works with your existing GPTHOUSE setup
...
# Load a demo dataset
dataset = gpthouse_optimizer.datasets.tiny_test()
...
prompt = gpthouse_optimizer.ChatPrompt(
  messages=[
...
optimizer = gpthouse_optimizer.MetaPromptOptimizer(model="openai/gpt-4")
...
[Quickstart guide](/agent_optimization/gpthouse_optimizer/quickstart).
...
The [GPTHOUSE Agent Optimizer](https://pypi.org/project/gpthouse-optimizer/) is an experimental Python
...
<Note>
  ...
  [LiteLLM Support for Optimizers](/agent_optimization/gpthouse_optimizer/litellm_support) guide.
</Note>
...
<Tip>
  ...
  [Github](https://github.com/comet-ml/gpthouse) or feel free to contribute by [extending
...
<Warning>
  ...
  [here](https://github.com/comet-ml/gpthouse/blob/main/sdks/gpthouse_optimizer/benchmarks/run_benchmark.py).
</Warning>
