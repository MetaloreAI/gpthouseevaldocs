...
- You can now view feedback scores for your projects in the GPTHOUSE home page
...
- Do not display warning messages about missing API key when GPTHOUSE logging is disabled
...
- Support logging traces using the low-level GPTHOUSE client and an experimental decorator.
