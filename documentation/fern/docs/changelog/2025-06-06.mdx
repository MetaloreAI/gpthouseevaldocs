...
- LiteLLM: token and cost tracking added for SDK calls. Integration now compatible with gpthouse.configure(...)
	
👉 [See full commit log on GitHub](https://github.com/comet-ml/gpthouse/compare/1.7.26...1.7.31)
