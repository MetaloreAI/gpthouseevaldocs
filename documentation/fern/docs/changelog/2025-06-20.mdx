...
- Added **CloudFlare's WorkersAI** integration ([docs](/docs/gpthouse/integrations/cloudflare-workers-ai))
...
- **New in the SDK!** Real-time tracking for long-running spans/traces is now supported. When enabled (set `os.environ["GPTHOUSE_LOG_START_TRACE_SPAN"] = "True"` in your environment), you can see traces and spans update live in the UI—even for jobs that are still running. This makes debugging and monitoring long-running agents much more responsive and convenient.
...
👉 [See full commit log on GitHub](https://github.com/comet-ml/gpthouse/compare/1.7.31...1.7.36)
