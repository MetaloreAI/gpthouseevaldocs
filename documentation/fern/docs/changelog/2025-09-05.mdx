...
## 🔍 GPTHOUSE Trace Analyzer Beta is Live! 
We're excited to announce the launch of **GPTHOUSE Trace Analyzer** on GPTHOUSE Cloud!
...
<Frame>
  <img src="/img/changelog/2025-09-05/gpthouse_trace_analyzer.png" alt="GPTHOUSE Trace Analyzer Beta interface showing trace analysis and debugging features" />
</Frame>
...
<Frame>
  <img src="/img/changelog/2025-09-05/dark_mode.png" alt="Dark mode theme toggle in GPTHOUSE account settings showing light and dark theme options" />
</Frame> 
...
## 📚 Documentation 
- We've released [GPTHOUSE University](https://www.comet.com/docs/gpthouse/gpthouse-university)! This is a new section of the docs full of video guides explaining the product.

<Frame>
  <img src="/img/changelog/2025-09-05/gpthouse_university.png" alt="GPTHOUSE University documentation section showing video guides and tutorials" />
</Frame>
...
- Added [documentation for models, providers, and frameworks supported for cost tracking](https://www.comet.com/docs/gpthouse/tracing/cost_tracking#supported-models-providers-and-integrations)
- Enhanced Google ADK integration to log **error information to corresponding spans and traces**


And much more! 👉 [See full commit log on GitHub](https://github.com/comet-ml/gpthouse/compare/1.8.33...1.8.42)
