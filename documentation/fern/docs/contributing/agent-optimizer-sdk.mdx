...
Before you start, please review our general [Contribution Overview](/contributing/overview) and the [Contributor License Agreement (CLA)](https://github.com/comet-ml/gpthouse/blob/main/CLA.md).

## Project Structure

The Agent Optimizer is located in the `sdks/gpthouse_optimizer` directory. Here's an overview of the key components:
...
_Remember to review our [Contributor License Agreement (CLA)](https://github.com/comet-ml/gpthouse/blob/main/CLA.md) before contributing._
