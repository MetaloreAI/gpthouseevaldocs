...
This guide will help you get started with contributing to GPTHOUSE's documentation.
...
This guide covers how to contribute to the two main parts of GPTHOUSE's documentation: **This Documentation Website**: Built with [Fern](https://www.buildwithfern.com/) and **Python SDK Reference Documentation**: Built with [Sphinx](https://www.sphinx-doc.org/en/master/).

Here's how you can work with either one:

<AccordionGroup>
  <Accordion title="Contributing to this Documentation Website (Fern)">
    This website (source in `apps/gpthouse-documentation/documentation`) is where our main guides, tutorials, and conceptual documentation live.
    ...
    <Steps>
      ...
      ### 2. Set up Locally
      ```bash
      cd apps/gpthouse-documentation/documentation
      ...
      Once you're happy with your changes, commit them and open a Pull Request against the `main` branch of the `comet-ml/gpthouse` repository.
    </Steps>

  </Accordion>
  <Accordion title="Contributing to the Python SDK Reference Documentation (Sphinx)">
    The Python SDK reference docs (source in `apps/gpthouse-documentation/python-sdk-docs`) are generated from docstrings in the Python codebase using [Sphinx](https://www.sphinx-doc.org/en/master/).
    <Steps>
      ### 1. Install Prerequisites
      ...
      ### 2. Set up Locally
      ```bash
      cd apps/gpthouse-documentation/python-sdk-docs
      # Install dependencies - Only needs to be run once
      pip install -r requirements.txt
      ...
      After editing docstrings, run `make dev` (or `make html` for a one-time build) in the `apps/gpthouse-documentation/python-sdk-docs` directory to regenerate the HTML and preview your changes.
