...
- **Rich Trace Visualization**: View complete interaction flows in the GPTHOUSE UI with inputs, outputs, and hierarchical [spans](/tracing/log_traces) for multi-step processes
