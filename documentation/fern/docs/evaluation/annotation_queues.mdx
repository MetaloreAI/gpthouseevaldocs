...
<Note>
  **Availability**: Annotation Queues are available on GPTHOUSE Cloud and Enterprise
  deployments. On self-hosted instances without user support, the feature can
  still be used, but all scores will be stored under the same user account.
</Note>
...
You can learn more about GPTHOUSE's annotation and evaluation features in:
