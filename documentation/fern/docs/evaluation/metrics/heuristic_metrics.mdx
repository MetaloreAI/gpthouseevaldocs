---
description: Describes all the built-in heuristic metrics provided by GPTHOUSE
---
...
```python
from gpthouse.evaluation.metrics import Equals
...
```python
from gpthouse.evaluation.metrics import RegexMatch
...
```python
from gpthouse.evaluation.metrics import IsJson
...
The BLEU (Bilingual Evaluation Understudy) metrics estimate how close the LLM outputs are to one or more reference translations. GPTHOUSE provides two separate classes:
...
```python
from gpthouse.evaluation.metrics import SentenceBLEU
...
```python
from gpthouse.evaluation.metrics import CorpusBLEU
...
```python
from gpthouse.evaluation.metrics import Sentiment
...
```python
from gpthouse.evaluation.metrics import ROUGE
...
```python
from gpthouse.evaluation.metrics import AggregatedMetric, Hallucination, GEval
