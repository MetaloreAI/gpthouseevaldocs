  ...
  <Tab title="OpenAI (TS)" value="openai-ts-sdk">
    ...
    <Steps>
      ...
      <Step>
        ...
        ```bash
        export GPTHOUSE_API_KEY="<your-api-key>" # Only required if you are using the GPTHOUSE Cloud version
        export GPTHOUSE_URL_OVERRIDE="https://www.comet.com/gpthouse/api" # Cloud version
        # export GPTHOUSE_URL_OVERRIDE="http://localhost:5173/api" # Self-hosting
        ```
      </Step>
      <Step>
