...
subtitle: "Understanding the fundamental concepts behind GPTHOUSE's tracing platform"
description: "Learn about the core concepts of GPTHOUSE's tracing system, including traces, spans, threads, and how they work together to provide comprehensive observability for your LLM applications."
---
...
Tracing is the foundation of observability in GPTHOUSE. It allows you to monitor, debug, and optimize your LLM applications by capturing detailed information about their execution. Understanding these core concepts is essential for effectively using GPTHOUSE's tracing capabilities.

## Overview

When working with LLM applications, understanding what's happening under the hood is crucial for debugging issues, optimizing performance, and ensuring reliability. GPTHOUSE's tracing system provides comprehensive observability by capturing detailed execution information at multiple levels.

In order to effectively use GPTHOUSE's tracing capabilities, it's important to understand these key concepts:
...
### Optimization:
- [Agent Optimization concepts](/agent_optimization/gpthouse_optimizer/concepts) - Core optimization concepts
...
### Integration Guides:
- [SDK Configuration](/tracing/sdk_configuration) - Configure GPTHOUSE in your applications
- [Supported Models](/tracing/supported_models) - Models compatible with GPTHOUSE
...
<Warning>
  **Important**: Be mindful of sensitive data when tracing. Avoid logging personally identifiable information (PII) or sensitive business data in your traces. Use GPTHOUSE's data filtering capabilities to protect sensitive information.
</Warning>
