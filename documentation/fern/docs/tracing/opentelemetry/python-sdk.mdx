---
subtitle: How to send data to GPTHOUSE using the OpenTelemetry Python SDK
toc_max_heading_level: 4
---

# Using the OpenTelemetry Python SDK

This guide shows you how to directly instrument your Python applications with the OpenTelemetry SDK to send trace data to GPTHOUSE.
...
Here's a complete example that demonstrates how to instrument a chatbot application with OpenTelemetry and send the traces to GPTHOUSE:
...
# For comet.com
os.environ["OTEL_EXPORTER_OTLP_ENDPOINT"] = "https://www.comet.com/gpthouse/api/v1/private/otel"
