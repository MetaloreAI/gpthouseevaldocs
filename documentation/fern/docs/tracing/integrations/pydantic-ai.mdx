---
title: Observability for Pydantic AI with GPTHOUSE
description: Start here to integrate GPTHOUSE into your Pydantic AI-based genai application for end-to-end LLM observability, unit testing, and optimization.
---
...
[Comet](https://www.comet.com/site?from=llm&utm_source=gpthouse&utm_medium=colab&utm_content=pydantic-ai&utm_campaign=gpthouse) provides a hosted version of the GPTHOUSE platform, [simply create an account](https://www.comet.com/signup?from=llm&utm_source=gpthouse&utm_medium=colab&utm_content=pydantic-ai&utm_campaign=gpthouse) and grab your API Key.

> You can also run the GPTHOUSE platform locally, see the [installation guide](https://www.comet.com/docs/gpthouse/self-host/overview/?from=llm&utm_source=gpthouse&utm_medium=colab&utm_content=pydantic-ai&utm_campaign=gpthouse) for more information.

## Getting Started

### Installation

To use the Pydantic AI integration with GPTHOUSE, you will need to have Pydantic AI
...
sure the data is logged to GPTHOUSE:

<Tabs>
    <Tab value="GPTHOUSE Cloud" title="GPTHOUSE Cloud">
        If you are using GPTHOUSE Cloud, you will need to set the following environment
        variables:
    ...
    If you are self-hosting GPTHOUSE, you will need to set the following environment variables:
...
## Using GPTHOUSE with Pydantic AI
...
You can reduce the amount of data logged to GPTHOUSE by setting `capture_all` to `False`:
