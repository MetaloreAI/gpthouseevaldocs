---
title: Observability for Mastra with GPTHOUSE
description: Start here to integrate GPTHOUSE into your Mastra-based genai application for end-to-end LLM observability, unit testing, and optimization.
---
...
<Tabs>
    <Tab value="GPTHOUSE Cloud" title="GPTHOUSE Cloud">
        ...
        OTEL_EXPORTER_OTLP_ENDPOINT=https://www.comet.com/gpthouse/api/v1/private/otel
    ...
    <Tab value="Enterprise deployment" title="Enterprise deployment">
        ...
        # GPTHOUSE configuration
        OTEL_EXPORTER_OTLP_ENDPOINT=https://<comet-deployment-url>/gpthouse/api/v1/private/otel
        OTEL_EXPORTER_OTLP_HEADERS='Authorization=<your-api-key>,Comet-Workspace=default'
        ```
...
If you have any questions or suggestions for improving the Mastra integration, please [open an issue](https://github.com/comet-ml/gpthouse/issues/new/choose) on our GitHub repository.
