---
title: Observability for Agno with GPTHOUSE
description: Start here to integrate GPTHOUSE into your Agno-based genai application for end-to-end LLM observability, unit testing, and optimization.
---
...
To use the Agno integration with GPTHOUSE, you will need to have the following
packages installed:
...
## Using GPTHOUSE with Agno

The example below shows how to use the Agno integration with GPTHOUSE:
