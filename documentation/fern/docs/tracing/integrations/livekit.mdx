---
title: Observability for LiveKit with GPTHOUSE
description: Start here to integrate GPTHOUSE into your LiveKit-based genai application for end-to-end LLM observability, unit testing, and optimization.
---
...
To use the LiveKit Agents integration with GPTHOUSE, you will need to have LiveKit Agents and the required OpenTelemetry packages installed:
...
Configure your environment variables based on your GPTHOUSE deployment:
...
## Using GPTHOUSE with LiveKit Agents
...
def setup_gpthouse_tracing(metadata: dict[str, AttributeValue] | None = None):
    """Set up GPTHOUSE tracing for LiveKit Agents"""
...
async def entrypoint(ctx: JobContext):
    ...
    trace_provider = setup_gpthouse_tracing(
...
If you have any questions or suggestions for improving the LiveKit Agents integration, please [open an issue](https://github.com/comet-ml/gpthouse/issues/new/choose) on our GitHub repository.
