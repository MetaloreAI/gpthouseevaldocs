---
title: Observability for AG2 with GPTHOUSE
description: Start here to integrate GPTHOUSE into your AG2-based genai application for end-to-end LLM observability, unit testing, and optimization.
---
...
To use the AG2 integration with GPTHOUSE, you will need to have the following
packages installed:

```bash
pip install -U "ag2[openai]" gpthouse opentelemetry-sdk opentelemetry-instrumentation-openai opentelemetry-instrumentation-threading opentelemetry-exporter-otlp
```
...
## Using GPTHOUSE with AG2

The example below shows how to use the AG2 integration with GPTHOUSE:
