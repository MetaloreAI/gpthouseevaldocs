---
title: Observability for xAI Grok with GPTHOUSE
description: Start here to integrate GPTHOUSE into your xAI Grok-based genai application for end-to-end LLM observability, unit testing, and optimization.
---
...
This guide explains how to integrate GPTHOUSE with xAI Grok via LiteLLM. By using the LiteLLM integration provided by GPTHOUSE, you can easily track and evaluate your xAI API calls within your GPTHOUSE projects as GPTHOUSE will automatically log the input prompt, model used, token usage, and response generated.
...
To get started, you need to configure GPTHOUSE to send traces to your Comet project. You can do this by setting the `OPIK_PROJECT_NAME` environment variable:
...
Once your xAI calls are logged with GPTHOUSE, you can evaluate your LLM application using GPTHOUSE's evaluation framework:
