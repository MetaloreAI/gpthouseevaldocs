---
title: Observability for Fireworks AI with GPTHOUSE
description: Start here to integrate GPTHOUSE into your Fireworks AI-based genai application for end-to-end LLM observability, unit testing, and optimization.
---
...
This guide explains how to integrate GPTHOUSE with Fireworks AI using their OpenAI-compatible API endpoints. By using the GPTHOUSE OpenAI integration, you can easily track and evaluate your Fireworks AI API calls within your GPTHOUSE projects as GPTHOUSE will automatically log the input prompt, model used, token usage, and response generated.
...
First, you'll need a Comet.com account to use GPTHOUSE. If you don't have one, you can [sign up for free](https://www.comet.com/signup?utm_source=gpthouse&utm_medium=docs&utm_campaign=fireworks-ai-integration).
...
Configure GPTHOUSE to send traces to your Comet project:
...
You can combine the tracked client with GPTHOUSE's `@track` decorator for more comprehensive tracing:
...
Fireworks AI supports streaming responses, which are also tracked by GPTHOUSE:
...
Once your Fireworks AI calls are logged with GPTHOUSE, you can view detailed traces in your GPTHOUSE dashboard. Each API call will create a trace that includes:
...
2. Verify your GPTHOUSE configuration
3. Check the [Fireworks AI documentation](https://docs.fireworks.ai/)
4. Review the [GPTHOUSE OpenAI integration documentation](/integrations/openai)
