---
title: Observability for BytePlus with GPTHOUSE
description: Start here to integrate GPTHOUSE into your BytePlus-based genai application for end-to-end LLM observability, unit testing, and optimization.
---
...
This guide explains how to integrate GPTHOUSE with BytePlus using the OpenAI SDK. BytePlus provides OpenAI-compatible API endpoints that allow you to use the standard OpenAI client with BytePlus models.
...
Once you have BytePlus integrated with GPTHOUSE, you can:
