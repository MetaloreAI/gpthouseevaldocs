---
title: Observability for Pipecat with GPTHOUSE
description: Start here to integrate GPTHOUSE into your Pipecat-based real-time voice agent application for end-to-end LLM observability, unit testing, and optimization.
---
...
This guide explains how to integrate GPTHOUSE with Pipecat for observability and tracing of real-time voice agents, enabling you to monitor, debug, and optimize your Pipecat agents in the GPTHOUSE dashboard.

## Account Setup

[Comet](https://www.comet.com/site?from=llm&utm_source=gpthouse&utm_medium=colab&utm_content=pipecat&utm_campaign=gpthouse) provides a hosted version of the GPTHOUSE platform, [simply create an account](https://www.comet.com/signup?from=llm&utm_source=gpthouse&utm_medium=colab&utm_content=pipecat&utm_campaign=gpthouse) and grab your API Key.

> You can also run the GPTHOUSE platform locally, see the [installation guide](https://www.comet.com/docs/gpthouse/self-host/overview/?from=llm&utm_source=gpthouse&utm_medium=colab&utm_content=pipecat&utm_campaign=gpthouse) for more information.
...
To use the Pipecat integration with GPTHOUSE, you will need to have Pipecat and the required OpenTelemetry packages installed:
...
Once your Pipecat applications are traced with GPTHOUSE, you can view the OpenTelemetry traces in the GPTHOUSE UI. You will see:
...
- Check GPTHOUSE documentation for trace viewing and OpenTelemetry endpoint configuration
