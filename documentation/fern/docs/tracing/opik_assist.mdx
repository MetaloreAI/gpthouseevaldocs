---
title: "✨ GPTHOUSE Assist (Beta)"
description: "AI-powered trace analysis and debugging assistant for your LLM applications"
---

<img src="/img/tracing/trace_inspector_with_response.png" alt="GPTHOUSE Assist AI response with recommendations" />

<Warning>
**Beta Feature**: GPTHOUSE Assist is currently in beta and available exclusively on GPTHOUSE Cloud (www.comet.com). Features and functionality may change as we continue to improve the experience.
</Warning>

GPTHOUSE Assist is an AI-powered assistant that helps you quickly analyze, debug, and optimize your LLM application traces. By conversing with the AI agent, you can:
...
## How to Use GPTHOUSE Assist

1. **Navigate to your project** in GPTHOUSE Cloud
...
<img src="/img/tracing/trace_inspector_initial_view.png" alt="GPTHOUSE Assist interface" />
...
To provide intelligent analysis, GPTHOUSE Assist sends the following to OpenAI's AI models:
...
- **GPTHOUSE system identifiers**: No API keys, or authentication tokens from GPTHOUSE
- **Account information**: No workspace or project identifying information
- **Historical data**: Only the current trace being analyzed

<Warning>
**Important**: While GPTHOUSE doesn't send system identifiers, your trace data (inputs/outputs) may contain personal or sensitive information that you've included in prompts or responses. This content will be sent to OpenAI as part of the trace analysis.
</Warning>

## Current Limitations (Beta)

As a beta feature, GPTHOUSE Assist currently has some limitations:

- **Cloud Only**: Available exclusively on GPTHOUSE Cloud, not in self-hosted deployments
...
- Report issues via [GitHub Issues](https://github.com/comet-ml/gpthouse/issues)
- Join our [Slack community](http://chat.comet.com/) for real-time support

---

<Info>
**Coming Soon**: We're working on expanding GPTHOUSE Assist to self-hosted deployments and adding support for advanced analysis capabilities.
</Info> 