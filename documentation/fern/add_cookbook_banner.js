...
const injectGitHubLink = () => {
  ...
  if (path.includes("quickstart_notebook")) {
    notebookPath = "/apps/gpthouse-documentation/documentation/docs/cookbook/quickstart_notebook.ipynb";
  } else if (path.includes("evaluate_hallucination_metric")) {
    notebookPath = "/apps/gpthouse-documentation/documentation/docs/cookbook/evaluate_hallucination_metric.ipynb";
  } else if (path.includes("evaluate_moderation_metric")) {
    notebookPath = "/apps/gpthouse-documentation/documentation/docs/cookbook/evaluate_moderation_metric.ipynb";
  } else if (path.includes("dynamic_tracing_control")) {
    notebookPath = "/apps/gpthouse-documentation/documentation/docs/cookbook/dynamic_tracing_cookbook.ipynb";
  } else {
    return; // No notebook available for this page
  }
  
  const githubUrl = "https://github.com/comet-ml/gpthouse/blob/main" + notebookPath;
  const colabUrl = "https://colab.research.google.com/github/comet-ml/gpthouse/blob/main" + notebookPath;
