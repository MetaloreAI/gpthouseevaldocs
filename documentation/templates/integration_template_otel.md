---
title: Observability for [FRAMEWORK_NAME] with GPTHOUSE
description: Start here to integrate GPTHOUSE into your [FRAMEWORK_NAME]-based genai application for end-to-end LLM observability, unit testing, and optimization.
---
...
[Comet](https://www.comet.com/site?from=llm&utm_source=gpthouse&utm_medium=colab&utm_content=[framework_name]&utm_campaign=gpthouse) provides a hosted version of the GPTHOUSE platform, [simply create an account](https://www.comet.com/signup?from=llm&utm_source=gpthouse&utm_medium=colab&utm_content=[framework_name]&utm_campaign=gpthouse) and grab your API Key.

> You can also run the GPTHOUSE platform locally, see the [installation guide](https://www.comet.com/docs/gpthouse/self-host/overview/?from=llm&utm_source=gpthouse&utm_medium=colab&utm_content=[framework_name]&utm_campaign=gpthouse) for more information.

<Frame>
  <img src="/img/tracing/[framework_name]_integration.png" alt="[FRAMEWORK_NAME] tracing" />

<!--
Screenshot should be placed at: apps/gpthouse-documentation/documentation/fern/img/tracing/[framework_name]_integration.png
...
To use the [FRAMEWORK_NAME] integration with GPTHOUSE, you will need to have [FRAMEWORK_NAME] and the required OpenTelemetry packages installed:
...
In addition, you will need to set the following environment variables to configure OpenTelemetry to send data to GPTHOUSE:

<Tabs>
    <Tab value="GPTHOUSE Cloud" title="GPTHOUSE Cloud">
        If you are using GPTHOUSE Cloud, you will need to set the following
        environment variables:
            
        ```bash wordWrap
        export OTEL_EXPORTER_OTLP_ENDPOINT=https://www.comet.com/gpthouse/api/v1/private/otel
    ...
    <Tab value="Enterprise deployment" title="Enterprise deployment">
        If you are using an Enterprise deployment of GPTHOUSE, you will need to set the following
        environment variables:

        ```bash wordWrap
        export OTEL_EXPORTER_OTLP_ENDPOINT=https://<comet-deployment-url>/gpthouse/api/v1/private/otel
        export OTEL_EXPORTER_OTLP_HEADERS='Authorization=<your-api-key>,Comet-Workspace=default'
        ```
    ...
    If you are self-hosting GPTHOUSE, you will need to set the following environment
    variables:
...
## Using GPTHOUSE with [FRAMEWORK_NAME]
...
request on [Github](https://github.com/comet-ml/gpthouse/issues).
