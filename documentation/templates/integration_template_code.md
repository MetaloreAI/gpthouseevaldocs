---
title: Observability for [INTEGRATION_NAME] with GPTHOUSE
description: Start here to integrate GPTHOUSE into your [INTEGRATION_NAME]-based genai application for end-to-end LLM observability, unit testing, and optimization.
---

[INTEGRATION_NAME]([INTEGRATION_WEBSITE_URL]) is [INTEGRATION_DESCRIPTION].

This guide explains how to integrate GPTHOUSE with [INTEGRATION_NAME] using the [INTEGRATION_NAME] integration provided by GPTHOUSE. By using the [INTEGRATION_NAME] integration provided by GPTHOUSE, you can easily track and evaluate your [INTEGRATION_NAME] API calls within your GPTHOUSE projects as GPTHOUSE will automatically log the input prompt, model used, token usage, and response generated.

## Account Setup

[Comet](https://www.comet.com/site?from=llm&utm_source=gpthouse&utm_medium=colab&utm_content=[integration_name]&utm_campaign=gpthouse) provides a hosted version of the GPTHOUSE platform, [simply create an account](https://www.comet.com/signup?from=llm&utm_source=gpthouse&utm_medium=colab&utm_content=[integration_name]&utm_campaign=gpthouse) and grab your API Key.

> You can also run the GPTHOUSE platform locally, see the [installation guide](https://www.comet.com/docs/gpthouse/self-host/overview/?from=llm&utm_source=gpthouse&utm_medium=colab&utm_content=[integration_name]&utm_campaign=gpthouse) for more information.
...
```bash
pip install gpthouse [integration_package]
```
...
Set up [INTEGRATION_NAME] with GPTHOUSE tracking:

```python
from gpthouse.integrations.[integration_module] import track_[integration_name]
...
Once your [INTEGRATION_NAME] calls are logged with GPTHOUSE, you can view them in the GPTHOUSE UI. Each API call will create a trace with detailed information including:
...
<!--
Screenshot should be placed at: apps/gpthouse-documentation/documentation/fern/img/tracing/[integration_name]_integration.png
Documentation reference path: /img/tracing/[integration_name]_integration.png
-->

## Feedback Scores and Evaluation

Once your [INTEGRATION_NAME] calls are logged with GPTHOUSE, you can evaluate your LLM application using GPTHOUSE's evaluation framework:
...
Once you have [INTEGRATION_NAME] integrated with GPTHOUSE, you can:
